...
def Comment_details_to_sql(channel_id):
    ...
    try:
         ...
         if 'Duplicate entry' in str(e):
            ...
            conn.rollback()
            my_bar.empty()
            tab2.info("Sorry , Data Upload Unsuccessful . Try another Channel id")
...
if questions == '1. What are the names of all the videos and their corresponding channels?':
   ...
   with col2:
      ...
      fig5 = px.pie(df_10, values='No of Comments', names='Name of the Video', title="Top 20 Videos with highest number of comments",hole=0.4, color_discrete_sequence = px.colors.sequential.Teal)
